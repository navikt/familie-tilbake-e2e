...
class Saksbehandler(
    ...
    fun opprettTilbakekreving(
        ...
        val eksternBrukId = requireNotNull(familieTilbakeKlient.opprettTilbakekreving(data = data).data) { "Det oppstod en feil under opprettelse av tilbakekreving" }
        ...
        println(
            "Opprettet behandling med eksternFagsakId: ${gjeldendeBehandling.eksternFagsakId} og " +
    ...
    fun opprettKravgrunnlag(
        ...
        println(
            "Sendte inn $status kravgrunnlag med eksternFagsakId: ${gjeldendeBehandling.eksternFagsakId} " +
    ...
    fun opprettKravgrunnlagForManueltOpprettelse(
        ...
        println(
            "Sendte inn $status kravgrunnlag med eksternFagsakId: ${scenario.eksternFagsakId} " +
    ...
    fun opprettRevurdering(scenario: Scenario, behandlingsårsakstype: Behandlingsårsakstype) {
        ...
        println(
            "Opprettet revurdering med eksternFagsakId: ${gjeldendeBehandling.eksternFagsakId} og " +
    ...
    fun kanBehandlingOpprettesManuelt(scenario: Scenario) {
        val kanOppretteManueltResponse =
            familieTilbakeKlient.kanBehandlingOpprettesManuelt(
                ytelsestype = scenario.ytelsestype,
                eksternFagsakId = scenario.eksternFagsakId
            )
        ...
        assertTrue(
            kanOppretteManueltResponse.data!!.kanBehandlingOpprettes,
    ...
    fun opprettStatusmelding(status: KodeStatusKrav) {
        val data = StatusmeldingData(
            ...
            eksternBehandlingId = requireNotNull(gjeldendeBehandling.eksternBehandlingId) { "EksternBehandlingId ikke definert. Opprett kravgrunnlag først." }
        ).lag()
    ...
    fun hentBehandlingId(fagsystem: Fagsystem, eksternFagsakId: String, eksternBrukId: String?): String {
        ...
        throw Exception(
            "Fant ingen behandling med eksternBrukId: $eksternBrukId med eksternFagsakId: $eksternFagsakId" +
    ...
    fun behandleFakta(behandlingId: String, hendelsestype: Hendelsestype, hendelsesundertype: Hendelsesundertype) {
        ...
        println(
            "Behandling $behandlingId ble behandlet i steg fakta: hendelsestype $hendelsestype, " +
                "hendelsesundertype $hendelsesundertype"
        )
    }
    ...
    fun behandleForeldelse(beslutning: Foreldelsesvurderingstype) {
        ...
        val data = BehandleForeldelseData(
    ...
    fun behandleVilkårsvurdering(
        ...
        println(
            "Behandling $behandlingId ble behandlet i steg vilkårsvurdering: " +
                "vilkårvurderingsresultat $vilkårvurderingsresultat"
        )
    }
    ...
    fun behandleFatteVedtak(behandlingId: String, godkjent: Boolean) {
        ...
        println(
            "Behandling $behandlingId ble behandlet i steg fatte vedtak: " +
    ...
    fun erBehandlingISteg(
        ...
        println(
            "Behandling $behandlingId er bekreftet i " +
    ...
    fun erBehandlingAvsluttet(behandlingId: String, resultat: Behandlingsresultatstype, vergeFjernet: Boolean? = false) {
        ...
        when (resultat) {
            ...
            in iverksatttyper -> {
                ...
                throw Exception(
                    "Behandling var i status AVSLUTTET men resultattypen angitt var ${behandling.resultatstype}" +
    ...
    fun beregn() {
        val data = requireNotNull(gjeldendeBehandling.feilutbetaltePerioder?.map { it.periode }) { "Autotest mangler informasjon om perioder å beregne feilutbetalinger for" }

        familieTilbakeKlient.beregn(
            behandlingId = gjeldendeBehandling.behandlingId,
            data = data
        ).data
