...
data class Kravgrunnlag(val detaljertKravgrunnlagMelding: DetaljertKravgrunnlagMelding) {

    data class DetaljertKravgrunnlagMelding(val detaljertKravgrunnlag: DetaljertKravgrunnlag) {
